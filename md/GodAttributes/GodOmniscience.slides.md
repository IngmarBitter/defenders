...
* From Latin: omni (all) + scientia (knowledge)  
...
* He searches every heart and understands our intentions  
* Even our secret plans are fully known to Him (also see Psalm 94:11)  
...
<p style="text-align: right; margin-top: -1em; margin-bottom: -1em;">    <em>Isaiah 46:9b-10 (NKJV)</em></p>

* God alone declares the future with certainty  
* His plans and purposes are unshakable and always prevail  
* Demonstrates His sovereignty and omniscience  
* Also seen in prophecies like Daniel 2 or Christ’s birth (Micah 5:2)  

---

## Foreknowledge Proves Deity
...
<p style="text-align: right; margin-top: -1em; margin-bottom: -1em;">    <em>Isaiah 41:22-23 (NKJV)</em></p>
...
* Foreknowledge reflects, not dictates, our choices <small>(?! more to follow)</small>
* Foreknowledge does not remove free will <small>(?! more to follow)</small>
...
* Jesus predicted:  
  * Peter’s denial, Judas’ betrayal, His own suffering, death, and resurrection  
* Demonstrates divine omniscience  

---

## God Knows Hypothetical Would-Truths
...
## God Knows Intentional Would-Truths
...
<p style="text-align: right; margin-top: -1em; margin-bottom: -1em;">    <em>Psalm 147:5 (NKJV)</em></p>
...
* **Omnisciensce**: God knows all facts and believes no lies
* God kown all truths and nothing but the truth
* God knows past, present and future form each atom to the entire universe
* God knows our thoughts before we think them and our free choices before we make them
...
* God knowing ***Would-Truths*** is His ***Middle Knowledge*** and core to ***Molinism*** (more details to follow)
...
* Facts God knows: People get hungry  
* Self-knowledge: I am hungry  
* Self-knowledge motivates action (eat chocolate)  
* Without self-knowledge, factual knowledge alone is insufficient for action  

* God’s cognitive excellence exceeds omniscience  
  * Factual knowledge + self-knowledge  
...
* This makes God’s intellectual excellence greater than any being who acquires knowledge  
...
* This should inspire praise, adoration, and wonder  
...
* Raises two key questions:  
  ...
  * The nature of divine foreknowledge and human free will  
* How can we be free if God infallibly foreknows our actions?  
* How can God foreknow free actions?  
...
* Example:  
  * God foreknows Peter will deny Christ three times  
  * Does this mean Peter is fated to deny Christ?  
* Does divine foreknowledge imply fatalism?  

---

## Fatalism and Divine Foreknowledge

![](OmniPics/Pinochio.jpg style="float: right; width: 9rem")

* Fatalism: Everything happens necessarily  
* Some theologians (Luther, Calvin) equate foreknowledge with foreordination:  
...
* Problems  
  ...
  * Makes us God's toys
  * *Caused by God* and *our free choice* cannot both be true
...
* **Foreordination**: God’s sovereign act of determining the course of events, choosing which possibilities to actualize in the created world such that they align with His ultimate purposes
...
* Two freely choosable options:
  * If you choose chocolate, God foreknows that
...
* God’s foreknowledge does not force you to choose accordingly
* Your choice forces God’s foreknowledge to be accordingly
...
1. **Middle Knowledge**: Free choices are the logical start. God foreknows how anyone would act in any hypothetical circumstance  
2. **Infinite Possible Worlds**: God evaluates all possible worlds with all combinations of circumstances and associated free choices and subsequent outcomes  
3. **Divine Foreordination**: God chooses the possible world with His preferred circumstances and associated preferred foreknown free choices to create as our real world
4. **Decree**: The infinite hypotheticals collapse into one reality captured in God’s decree, aligned with His purposes  
...
* God’s knowledge tracks reality without determining it  
...
* Middle knowledge addresses how God knows future events  
* Two models of divine cognition:  
  * **Perceptualist** model:
    * God "sees" the future  
  * **Conceptualist** model:
    * God’s knowledge is intrinsic and innate, He "just knows"
      * As we "just know" how to breathe

---

## Perceptualist Model of Divine Cognition

![](OmniPics/GodSeesFuture.jpg style="float: right; width: 9rem")

* Perceptualist model: God "looks" and "sees" what is there  
* Assumes God "foresees" the future like sense perception  
* Logical Challenges
  * Future events do not yet exist, so there is nothing to perceive  
  * Alternate Would and Could futures will never exist, thus cannot be perceived under any nature of time model  

---

## Conceptualist Model of Divine Cognition

![](OmniPics/GodGlowBrain.jpg style="float: right; width: 9rem")

* God’s knowledge is intrinsic and innate, He "just knows"
      * As we "just know" how to breathe  
* God’s knowledge is not acquired but essential to His nature  
* Challenges for Understanding
  * Harder to comprehend than "looking into the future"
  * No knowledge acquisition mechanism (is implicit)
  * Why it's not affecting our freedom to choose
    * All resolved after reflection — better model overall
...
* Not **could** happen. Not mere possibilities (e.g., Scrooge becoming a florist)  
* But **Would**: What **would** happen **if** Scrooge does not repent  

* Optional Poll: Is The Matrix (Neo’s blue/red pill choice) more familiar to you?
...
* **Middle knowledge**: God knows all "***would-truths***"
  * Example: "If you were in Peter’s place, you would deny Jesus"
    * Not foreknowledge, as the situation never occurs

* Debate: Does God have middle knowledge?
  * Proponents (e.g., Luis Molina, Craig) say yes
    * God knows what creatures would freely do in any circumstance
  * Opponents (Luther, Calvin) say no
    * God only has simple foreknowledge of what will happen

---

## Example: Divine Providence in Genesis 50:20
...
<p style="text-align: right; margin-top: -1em; margin-bottom: -1em;">    <em>Genesis 50:20 (NKJV)</em></p>

* Joseph’s brothers intended harm, but God used their actions for good  
* Demonstrates God’s ability to bring good out of evil  
* Highlights God’s sovereignty and providence in human history
  * Achived through His middle knowledge
  * He plans "around" our sinful choices to achive His ultimate purposes.

---

## Complexity of Middle Knowledge

![](OmniPics/BackToTheFuture.jpg style="float: right; width: 9rem")
...
![](OmniPics/ScaleFreeAndGuided.jpg style="float: right; width: 9rem")
...
## Theological Importance of Middle Knowledge

![](OmniPics/GodsHandAndPeolpe.jpg style="float: right; width: 9rem")

* Middle knowledge reconciles divine sovereignty and human freedom  
...
![](OmniPics/TrustAndPray.jpg style="float: right; width: 9rem")
...
![](OmniPics/RememberScripture.jpg style="float: right; width: 9rem")

* No thought or deed is hidden from God  
* Calls us to honesty and integrity  
* Live with the awareness that He kows our secrets and desires
* Let His omniscience guide us toward righteousness
  * When tempted, remember God knows your thought struggle and lovingly guides you
...
* Take comfort in knowing He works all things for our good
  * That's our ultimate good, not necessarily what we crave now
    * Confidence of eternity in heaven is comforting even now

---

## Application: Worship and Adoration

![](OmniPics/Adoration.jpg style="float: right; width: 9rem")
