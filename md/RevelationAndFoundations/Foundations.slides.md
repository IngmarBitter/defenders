...
* ... That is loving God with our mind

---

## Christ only as in the Bible
...
## Study Doctrine to mature as Christians

![](foundationPics/bibleStudy.jpg style="float: right; width: 9rem")
...
![](foundationPics/apologetics.jpg style="float: right; width: 9rem")

* No need to apologize for anything
* Branch of Christian theology
* Provides rational justification for Christian truth claims

---

## Theoretical Discipline

![](foundationPics/theoretical.jpg style="float: right; width: 9rem")

* Different from evangelism
* Primarily theoretical
* Practical when there are barriers before the gospel

---

## Importance of Apologetics

![](foundationPics/TopThree.jpg style="float: right; width: 9rem")

* Vital for the survival of Christianity in Western culture
* Three key apologetics roles:
  1. Shaping culture
...
![](foundationPics/BibleAndScienceBooks.jpg style="float: right; width: 9rem")

* Gospel is heard against cultural background that assumes atheism
* Christianity seen as viable in some cultures, absurd in others
...
## Strengthening Believers Defense

![](foundationPics/footballBible.jpg style="float: right; width: 9rem")

* Apologetics builds up individual believers
* Provides substance beyond emotions 
  * (Ann Kiemel women's speaker)
* Helps answer difficult questions
* Prevents falling away

---

## Strengthening Believers Offense

![](foundationPics/offense.jpg style="float: right; width: 9rem")

* Encourages fearless evangelism
* Positive up-building effects
* Example: Debates as "power encounters"
...
![](foundationPics/apologeticsEarth.jpg style="float: right; width: 9rem")

* Apologetics is vital for:
  * Shaping culture
...
](https://ingmarbitter.github.io/defenders/CreeksideDefenders.md.html)
