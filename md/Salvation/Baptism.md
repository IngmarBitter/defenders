...
* The accounts in Acts where the timing of baptism and receiving the Holy Spirit are recorded and are never simultaneous must be considered exceptions to the rule. Even though there are no explicit examples that align with the rule, the rule still holds, as it is derived from teaching verses rather than historical account verses.
