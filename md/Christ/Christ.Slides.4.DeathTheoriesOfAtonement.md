...
* Luther describes the cross as a marvelous transaction:
  ...
  * "The Law growls: 'If Your Son is taking the sin of the world, I see no sins anywhere else but in Him. He shall die on the Cross.' And the Law kills Christ. But we go free"
* And the mirror image: "Believe in Christ and your sins will be pardoned. His righteousness will become your righteousness, and your sins become His sins"
...
* Sin can be understood in three ways, each requiring a different kind of satisfaction:
  ...
  * As **hostility** → God is **offended party** → Christ is our **mediator** (He reconciles us)
...
* Normally, punishing an innocent person instead of the criminal would be unjust. Turretin identifies **five conditions** that make substitution lawful:
  ...
  2. **Free consent** — the substitute must volunteer freely
...
## Infinite Worth of Christ's Suffering

![](pics/PenalSubstitution.jpg style="float: right; width: 7rem")

* **Objection (Socinus):** Christ suffered only a few hours — how can that equal the eternal damnation each sinner deserves?
...
* Christ endured a violent physical death on the cross
...
## Double Imputation: Heart of Justification

![](pics/PenalSubstitution.jpg style="float: right; width: 6.65rem")
...
* A mirror-image transaction:
  ...
  * Christ's **righteousness** is imputed to our account → we are declared righteous
...
* Two dimensions of the righteousness credited to us:
  * **Righteousness of innocence** — remission of sins removes guilt, restoring innocence
...
![](pics/PenalSubstitution.jpg style="float: right; width: 6.65rem; margin-top: -0.5em")
...
* **Justification** = legal declaration that we are righteous — based on imputation
...
* No single facet is sufficient; together reveal the full glory of Christ's death
...
* Next: [Christ's Death: Penal Substitution Defended](Christ.Slides.5.DeathPenalSubstitutionDefended.html)
