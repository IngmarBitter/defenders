...
3) Therefore, the universe has a cause
  ...
  Makes sense because
    ...
    it follows logically from (1) and (2)<br>
...
* Makes sense because
  ...
  * Thermodynamics of the universe predict heat death
    * We are still alive, so no infinite time can have passed
...
* Makes sense because
  * If false, # of past events would be infinite
    * An actually infinite number of past events cannot exist
      * Otherwise Hilberts hotel could be real
    * A series formed successively cannot be actually infinite
      * Otherwise counting from infinity to 0 would have finished already
...
* An infinate "starter" chain is eliminated by Occam's Razor
...
The universe could be pulsating big bang/crunch

* Still an overall closed system
  * Thus thermodynamics prediction still holds
  * Heat death should still occur after finite time
  * We are still alive, so no infinite time can have passed
...
* => these cannot be true
  ...
  * Agnosticism
    * Since we can have good reason to believe in God
