...
3. Doctrine of Revelation <sub><sup>Authority, General & Special Revelation, Biblical Inerrancy, Bible Canonicity<sub><sup>
4. Doctrine of God 
 1. God is .. <sub><sup>Knowing God, Self-Existing, Eternal, Omnipresent, Immutable, Immaterial, Omniscient, Holy, Loving<sub><sup>.
 1. God must exist <sub><sup>Properly Basic Belief, Leibnitz argument from Contingency, [Kalam Cosmological Argument](Kalam/Kalam.slides.html) , [Teleological Argument from Fine-Tuning](FineTuning/FineTuning.slides.html), Moral Argument from Absolute Moral Values, Ontological Argument<sub><sup>
...
16. Abortion <sub><sup>Wrong according to the Bible and secularly<sub><sup>
