...
* Key moves in the response:
  * Qualified negative retributivism (not an absolute prohibition)
  * Representation: Christ is a public person for those he saves
  * Imputation: legal guilt can be transferred by divine act
