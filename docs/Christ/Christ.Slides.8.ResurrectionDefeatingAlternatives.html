...
# The Resurrection: Defeating the Alternatives
...
## Where We Are: From Evidence to Explanation
...
* Last deck: the **biblical evidence** — the early creed, the witness list, the empty tomb, the transformed disciples
* This deck: the **historical apologetic** — does "God raised Jesus" best explain that evidence?
* The method: first establish the facts, then ask what best explains them
...
* Two routes to knowing the resurrection is real:
  * **Existential** — a personal encounter with the living Lord; how most Christians have known it, a "properly basic" belief grounded in the Spirit's witness
  * **Evidential** — historical investigation of what actually happened
* The vast majority of believers have never had the leisure or library to weigh the evidence, yet know Christ is risen because they know *Him*
* This deck walks the **evidential** road — which confirms and commends faith, but is not the foundation that holds the simplest believer
...
* Craig's historical argument openly assumes two things, each argued elsewhere:
  * **God exists** — established by natural theology (cosmological, teleological, moral arguments). Without this, miracles look impossible before the evidence is even weighed
...
* Bart Ehrman: there can be *in principle* **no historical evidence** for the resurrection
* Why? The historian has access only to the natural world, never the supernatural. He can confirm that a *belief* arose, never that a miracle occurred
* "It is a historical fact that some of Jesus' followers came to believe that he had been raised from the dead soon after his execution" — but the *truth* of that belief, he says, lies outside history
* If Ehrman is right, this whole project is misconceived from the start

---

## Why the Objection Fails (1) — It Touches Only Step Two

![](pics/ChristOverview.jpg style="float: right; width: 7rem")

* Even if granted, the objection strikes only at **Step 2** — the Step 1 facts (an empty grave, experiences of seeing Jesus) are **not supernatural** and are open to any historian
* Ehrman himself, in his Teaching Company lectures, granted the **burial, the empty tomb, and the appearances** were historically well-founded
* He later began to walk those concessions back — without refuting his own arguments for them
* An analogy: a Civil War historian can ask whether Lincoln's body went missing from its tomb, or whether his associates reported seeing him — ordinary historical questions, whatever the ultimate explanation

---

## Why the Objection Fails (2) — Inference Without Access
...
## Fact 2: The Post-Mortem Appearances
...
## Fact 3: The Origin of the Disciples' Belief

![](pics/ChristOverview.jpg style="float: right; width: 7rem")

* A **crucified Messiah** was a contradiction in terms — crucifixion was God's curse, the definitive proof that a messianic claimant was a fraud
* It should have **shattered** the movement. N. T. Wright: if your Messiah got himself crucified, you either went home or found a new Messiah
* Yet within days the disciples proclaimed a risen, vindicated Messiah and staked their lives on it
* Where did that belief come from?

---

## Not from Christianity or Paganism

![](pics/ChristOverview.jpg style="float: right; width: 7rem")

* Not from **Christianity** — it did not yet exist; this belief is its foundation
* Not from **paganism** — the alleged "dying-and-rising god" parallels are spurious: **apotheosis** stories (Hercules, Romulus), **disappearance** stories, or **seasonal** crop-cycle myths (Osiris, Adonis) — none a bodily resurrection within history
* T. N. D. Mettinger, who defends a *minority* view that a few such gods existed, still concedes Jesus' resurrection "retains its unique character... The riddle remains"
* And there was **no causal contact**: these cults were absent from first-century Palestine and abhorrent to Jews
...
* Jewish resurrection hope differed from Easter in two decisive ways:
  * It was always at the **end of the world** — never an individual raised within history (Joachim Jeremias: "nowhere does one find... anything comparable")
  * It was always **corporate** — all the righteous together, never one man ahead of the rest (Ulrich Wilckens)
* And there was **no concept of a dying-and-rising Messiah** at all (N. T. Wright: no other movement ever said its executed leader was raised)
* Left to their own categories, the disciples would have expected to see Jesus *translated to heaven* — not risen
...
## McCullagh's Criteria

![](pics/ChristOverview.jpg style="float: right; width: 7rem")

* Historian C. B. McCullagh: the best explanation of any body of facts is judged by —
  * **Explanatory scope** — does it cover the full range of data?
  * **Explanatory power** — does it make the data probable?
  * **Plausibility** — does it fit what else we know?
  * **Not *ad hoc*** — how many unsupported new assumptions must it add?
...
* **Scope:** narrow — it addresses (at most) the appearances, and says **nothing** about the empty tomb, so it must deny the tomb or bolt on a second theory
* It also fails to explain the **belief**: a vision of a dead man meant *translation*, not resurrection. James Dunn: "Why draw the astonishing conclusion that the eschatological resurrection had already taken place in the case of a single individual?"
* And the appearances' **diversity** — individuals and groups, believers and skeptics (James), even enemies (Paul) — bursts the psychological case-books. Postulating a chain reaction fails, since James and Paul don't stand in the chain
...
* Lüdemann's guilt-complex analysis rests on disputed **Freud/Jung** theory and on historical figures who cannot be examined — historians reject such "psychobiography"
* Krister Stendahl: Paul the Pharisee was, by his own account, "blameless," with a robust conscience — **Romans 7 is not his pre-Christian autobiography** (rejected by almost all expositors since the 1920s)
* Paul includes himself in the witness list to **raise** his experience to the objectivity of the others', not to reduce theirs to a vision (Crossan: he equates their *validity*, not their *mode*)
...
* Dale Allison's more sophisticated version: the disciples had **bereavement visions** — the vivid, palpable sightings of a lost loved one that the grieving sometimes report
* But the decisive lesson of such experiences is the opposite of what's needed: the bereaved do **not** conclude the deceased is physically alive again — they see them in the **afterlife**
* N. T. Wright: in the ancient world a vision of the dead would be evidence that the person **is dead**, not risen
* Allison himself concedes: such visions "would not, by themselves, have supplied" a reason to believe in a bodily resurrection

---

## Even Granting Visions: Translation, Not Resurrection

![](pics/ChristOverview.jpg style="float: right; width: 7rem")

* Suppose, generously, that someone emptied the tomb and the shocked disciples then **hallucinated** Jesus
...
* "God raised Jesus from the dead" explains **all three** facts at once — the empty tomb, the appearances, and the origin of the belief
* Its **explanatory power** is its great strength: on this hypothesis, the data are exactly what we would expect
* Every rival explains only one or two of the facts, and renders the data improbable
...
* McCullagh himself grants the scope and power, yet calls the hypothesis *ad hoc*
* But it adds essentially **one** new supposition — that God exists — and for the theist that is already part of the background knowledge, not an extra assumption
* The rivals smuggle in **more** unsupported assumptions: morally defective disciples, a merely superficial spear-thrust, a chain of psychological priming
* Science freely posits new entities (quarks, black holes) without being called *ad hoc* — the mere introduction of something new is not the problem

---

## A Miracle With a Context
...
* On every one of McCullagh's criteria, the resurrection hypothesis **meets or exceeds** its rivals
* Scholars who reject it are, by and large, left with **no explanation at all** — the facts simply stand there unexplained
* Once the prejudice against miracles is surrendered, "God raised Jesus from the dead" is the best explanation of the evidence
...
## 1. Vindicates Christ's Person and Work

![](pics/ChristWork.jpg style="float: right; width: 7rem")

<p style="font-family: 'EB Garamond', serif; font-style: italic;">"because He has appointed a day on which He will judge the world in righteousness by the Man whom He has ordained. He has given assurance of this to all by raising Him from the dead."</p><p style="text-align: right;"> <em>Acts 17:31 (NKJV)</em></p>

* **His person:** God raised the very man executed for "blasphemy" — a dramatic divine endorsement of Jesus' claims (Pannenberg: "the divine vindication of the man whom the Jews had rejected as a blasphemer")
* **His work:** the resurrection shows the Father **accepted** the cross — justice satisfied. Like a prisoner released because his sentence is served, Christ, having paid sin's penalty, could not be held by death

---

## 2. Relationship with the Living Lord

![](pics/ChristWork.jpg style="float: right; width: 7rem")

<p style="font-family: 'EB Garamond', serif; font-style: italic;">"And this is the testimony: that God has given us eternal life, and this life is in His Son. He who has the Son has life; he who does not have the Son of God does not have life."</p><p style="text-align: right;"> <em>1 John 5:11–12 (NKJV)</em></p>

* Because Jesus is alive, we can know Him **now** — union with the living Christ is the very essence of salvation
* This is the existential road of the opening slide: *"You ask me how I know He lives; He lives within my heart"*
* The simplest believer can be **sure**, apart from the historical evidence — the witness of the living Lord holds constant in every generation
...
<p style="font-family: 'EB Garamond', serif; font-style: italic;">"Jesus said to her, 'I am the resurrection and the life. He who believes in Me, though he may die, he shall live. And whoever lives and believes in Me shall never die. Do you believe this?'"</p><p style="text-align: right;"> <em>John 11:25–26 (NKJV)</em></p>

* Jesus speaks of death as one who has **conquered** it
* The grave is not the end — and that gives our present choices eternal weight

---

## 4. Physical and Psychological Healing

![](pics/ChristWork.jpg style="float: right; width: 7rem")

<p style="font-family: 'EB Garamond', serif; font-style: italic;">"who will transform our lowly body that it may be conformed to His glorious body, according to the working by which He is able even to subdue all things to Himself."</p><p style="text-align: right;"> <em>Philippians 3:21 (NKJV)</em></p>

* Christ is the **firstfruits** (1 Corinthians 15:20) — His resurrection body is the model of ours
* At history's end: **glorious, immortal, powerful** bodies, free of disease, aging, and death
* And a **new psyche** — the emotional scars every one of us carries, healed; integrated, whole persons at last

---

## 5. Guarantee of His Return

![](pics/ChristWork.jpg style="float: right; width: 7rem")

<p style="font-family: 'EB Garamond', serif; font-style: italic;">"For the Lord Himself will descend from heaven with a shout, with the voice of an archangel, and with the trumpet of God. And the dead in Christ will rise first. Then we who are alive and remain shall be caught up together with them in the clouds to meet the Lord in the air. And thus we shall always be with the Lord."</p><p style="text-align: right;"> <em>1 Thessalonians 4:16–17 (NKJV)</em></p>

* The resurrection makes the Incarnation **permanent** — the Son is embodied forever, not only for His earthly sojourn
* So the second coming cannot be demythologized away: He will return **bodily** and in glory, in the same risen body
...
* Remember the **two steps**: first the facts, then the best explanation
* Memorize the **three facts** — empty tomb, appearances, origin of belief — they summarize all the evidence
* This is *not* a "minimal facts" approach (Habermas) — it is a convenient summary; yet all three are in fact the **majority view** of New Testament scholars (the empty tomb ~75%; the appearances and the belief ~98%)
* Then keep hammering one question: **what best explains all three?**
