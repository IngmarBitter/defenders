...
**Deck 8 Wallace pair + Deck 9 polish — DONE 2026-08-09:** Deck 8 gained two slides after "Why the Conspiracy Theory Fails": "Wallace: The Missing Motive" (greed/lust/power + revenge, all inapplicable) and "Wallace: Five Conditions of a Successful Conspiracy" (apostles violate all five); J. Warner Wallace, *Cold-Case Christianity*, added to Credits; deck now 58 slides, anchors #slide40/#slide49. Deck 9 gained escalation markers on the hell and eternal-punishment slides ("the objections get harder now" / "the final problem ... harder to resolve compellingly") and Holy Pagans slide overflow trims.
